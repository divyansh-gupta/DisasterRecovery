/*
 * Created by Junjie Cheng on 2017.03.25  * 
...
public class PhotoManager implements Serializable {
    ...
    public FacesMessage storePhotoFile(UploadedFile file) {
        try {
            ...
            Responder responder = getResponderFacade().findByUsername(user_name);
...
//            UserPhoto photo = getUserPhotoFacade().findPhotosByUserID(user.getId()).get(0);
            ...
            File uploadedFile = inputStreamToFile(inputStream, responder.getId() + "." + fileExtension);

            // Create and save the thumbnail version of the uploaded file
            saveThumbnail(uploadedFile, responder.getId() + "." + fileExtension);
    ...
    private File inputStreamToFile(InputStream inputStream, String targetFilename) throws IOException {
        ...
        try {
            ...
            System.out.println(resultMsg.getDetail());
            FacesContext.getCurrentInstance().addMessage(null, resultMsg);
        }
     ...
     */
    private void saveThumbnail(File inputFile, String fileExtension) {
        ...
        try {
            ...
            File thumbnailPhotoFile = new File(Constants.PHOTOS_ABSOLUTE_PATH, "_thumbnail." + fileExtension);

            // Write the thumbnailPhoto into thumbnailPhotoFile with the file extension
            ImageIO.write(thumbnailPhoto, fileExtension, thumbnailPhotoFile);
